...
[**Download the Windows installer**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.5-windows-x64-installer.exe) · [**Portable ZIP**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.5-windows-portable-x64.zip) · [Release notes](https://github.com/jabrailkhalil/clickntranslate/releases/latest)
...
| --- | --- | --- |
| **Windows installer** | You want the simplest setup, shortcuts, and reliable in-app updates | [Download the installer](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.5-windows-x64-installer.exe) and run it |
| **Portable ZIP** | You want a self-contained folder you can move or keep on another drive | [Download the ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.5-windows-portable-x64.zip), extract it, and run `ClicknTranslate.exe` |
...
[**Download Click'n'Translate for Windows**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.5-windows-x64-installer.exe)
