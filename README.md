...
[**Download for Windows**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.3-windows-x64-installer.exe) · [Portable ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.3-windows-portable-x64.zip) · [Latest release](https://github.com/jabrailkhalil/clickntranslate/releases/latest)
...
1. Download and run the **[Windows installer](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.3-windows-x64-installer.exe)**.
...
Download the [portable ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.5.3-windows-portable-x64.zip), extract it to a permanent folder, and run `ClicknTranslate.exe`. Move the folder before enabling autostart or creating shortcuts.

### Updating from an older version

The updater in versions older than 1.5.0 cannot install the current release reliably. If you are upgrading from 1.4.x, close the old app and install 1.5.3 manually once. Users on 1.5.0 or newer can update to 1.5.3 from inside the app.
