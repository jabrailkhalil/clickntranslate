...
class TestUpdateRepair(unittest.TestCase):
    ...
    def test_release_repair_uses_pinned_https_package(self):
        ...
        self.assertIn("https://github.com/jabrailkhalil/clickntranslate/releases/download/v1.5.9/", source)
        self.assertIn("Click-n-Translate-1.5.9-windows-portable-x64.zip", source)
