...
SETTINGS_TEXT = {
    "en": {
        ...
        "result_window_mode_main_tooltip": "Show the result in the Translation tab of the main window.",
    ...
    "ru": {
        ...
        "result_window_mode_main_tooltip": "Показывать результат на вкладке «Перевод» в главном окне.",
    ...
    "es": {
        ...
        "result_window_mode_main_tooltip": "Mostrar el resultado en la pestaña Traducción de la ventana principal.",
    ...
    "de": {
        ...
        "result_window_mode_main_tooltip": "Ergebnis im Tab Übersetzung des Hauptfensters anzeigen.",
    ...
    "fr": {
        ...
        "result_window_mode_main_tooltip": "Afficher le résultat dans l’onglet Traduction de la fenêtre principale.",
    ...
    "zh": {
        ...
        "result_window_mode_main_tooltip": "在主窗口的“译文”标签中显示结果。",
