...
class SettingsWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.desktop_assistant_control.setFixedSize(engine_combo_width, engine_control_height)
        ...
        self.desktop_assistant_dismiss_button = QPushButton('×')
        self.desktop_assistant_dismiss_button.setObjectName('desktopAssistantDismiss')
        self.desktop_assistant_dismiss_button.setAccessibleName(assistant_text(lang, 'dismiss'))
        self.desktop_assistant_dismiss_button.setFixedSize(28, 28)
