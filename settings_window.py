...
SETTINGS_TEXT = {
    "en": {
        ...
        "copy_notification_tooltip": "Show a quiet on-screen confirmation when a result is copied, including in shadow mode.",
        ...
        "game_intro": "Follow changing text in selected areas or across the whole screen. Translation updates in place.",
        "game_launch": "Choose areas or the whole screen",
        ...
        "game_workflow_note": "Select text areas and press Start, or choose automatic whole-screen translation. Use its Pause/Stop controls or launch the mode again to stop.",
        ...
        "result_window_mode_main_tooltip": "Show the translation next to the input in the main window.",
    ...
    "ru": {
        ...
        "copy_notification_tooltip": "Показывает короткое уведомление на экране после копирования результата, в том числе в режиме тени.",
        ...
        "game_intro": "Переводите меняющийся текст в выбранных областях или на всём экране. Перевод обновляется прямо на месте.",
        "game_launch": "Выбрать области или весь экран",
        ...
        "game_workflow_note": "Выделите области и нажмите «Запустить» или выберите автоперевод всего экрана. Для него есть кнопки паузы и остановки; повторный запуск режима тоже его остановит.",
        ...
        "result_window_mode_main_tooltip": "Показывать перевод рядом с вводом в главном окне.",
    ...
    "es": {
        ...
        "copy_notification_tooltip": "Muestra una confirmación discreta en pantalla al copiar un resultado, también en modo sombra.",
        ...
        "game_intro": "Sigue el texto cambiante en zonas seleccionadas o en toda la pantalla. La traducción se actualiza en su lugar.",
        "game_launch": "Elegir zonas o toda la pantalla",
        ...
        "game_workflow_note": "Selecciona zonas y pulsa Iniciar, o elige la traducción automática de toda la pantalla. Usa Pausa/Detener o inicia el modo de nuevo para detenerlo.",
        ...
        "result_window_mode_main_tooltip": "Mostrar la traducción junto a la entrada en la ventana principal.",
    ...
    "de": {
        ...
        "copy_notification_tooltip": "Zeigt beim Kopieren eine kurze Bestätigung auf dem Bildschirm, auch im Schattenmodus.",
        ...
        "game_intro": "Wechselnden Text in ausgewählten Bereichen oder auf dem ganzen Bildschirm direkt an Ort und Stelle übersetzen.",
        "game_launch": "Bereiche oder ganzen Bildschirm wählen",
        ...
        "game_workflow_note": "Bereiche auswählen und Start drücken oder den ganzen Bildschirm automatisch übersetzen. Pause/Beenden verwenden; erneutes Starten beendet den Modus ebenfalls.",
        ...
        "result_window_mode_main_tooltip": "Übersetzung neben der Eingabe im Hauptfenster anzeigen.",
    ...
    "fr": {
        ...
        "copy_notification_tooltip": "Affiche une confirmation discrète à l’écran après la copie, même en mode ombre.",
        ...
        "game_intro": "Suivez le texte changeant dans des zones ou sur tout l’écran. La traduction s’actualise à son emplacement.",
        "game_launch": "Choisir des zones ou tout l’écran",
        ...
        "game_workflow_note": "Choisissez des zones puis Démarrer, ou traduisez automatiquement tout l’écran. Utilisez Pause/Arrêter ; relancer le mode l’arrête aussi.",
        ...
        "result_window_mode_main_tooltip": "Afficher la traduction à côté de la saisie dans la fenêtre principale.",
    ...
    "zh": {
        ...
        "copy_notification_tooltip": "复制结果后在屏幕上显示简短提示，在隐身模式下也会显示。",
        ...
        "game_intro": "跟踪所选区域或整个屏幕上不断变化的文字，译文在原位置自动更新。",
        "game_launch": "选择区域或整个屏幕",
        "game_languages": "语言：",
        ...
        "game_workflow_note": "选择文字区域后点击开始，或自动翻译整个屏幕。可使用暂停和停止按钮；再次启动该模式也可停止。",
        ...
        "result_window_mode_main_tooltip": "在主窗口的输入旁边显示译文。",
...
class SettingsWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.ocr_dim_strength_slider.setFixedHeight(24)
        ...
        self.game_scan_interval_slider.setFixedHeight(24)
        ...
        self.game_overlay_opacity_slider.setFixedHeight(24)
