...
1. Téléchargez et lancez le **[programme d'installation Windows](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/ClicknTranslate-Setup-v1.4.6-win64.exe)**.
