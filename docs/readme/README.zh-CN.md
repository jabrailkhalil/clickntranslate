...
[**下载 Windows 版**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/ClicknTranslate-Setup-v1.4.7-win64.exe) · [便携版 ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/ClicknTranslate-v1.4.7-win64.zip) · [最新版本](https://github.com/jabrailkhalil/clickntranslate/releases/latest)
...
1. 下载并运行 **[Windows 安装程序](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/ClicknTranslate-Setup-v1.4.7-win64.exe)**。
...
原版 1.4.5/1.4.6 launcher 无法替换正在运行的应用。请运行一次最新版中的小型 **Update Repair**；它会自动下载、校验、安装并启动重新发布的 1.4.7。设置、历史记录和语言包都会保留；重新发布的 1.4.7 已修复自动更新。
