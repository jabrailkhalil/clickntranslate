...
[**下载 Windows 版**](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.6.0-windows-x64-installer.exe) · [便携版 ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.6.0-windows-portable-x64.zip) · [最新版本](https://github.com/jabrailkhalil/clickntranslate/releases/latest)
...
1. 下载并运行 **[Windows 安装程序](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.6.0-windows-x64-installer.exe)**。
...
下载[便携版 ZIP](https://github.com/jabrailkhalil/clickntranslate/releases/latest/download/Click-n-Translate-1.6.0-windows-portable-x64.zip)，将其解压到固定文件夹，然后运行 `ClicknTranslate.exe`。请在启用开机启动或创建快捷方式之前确定最终存放位置。

### 从旧版本升级

1.5.0 之前版本的更新程序无法可靠地安装当前版本。如果从 1.4.x 升级，请关闭旧应用并手动安装一次 1.6.0。1.5.0 及更高版本的用户可以直接在应用内更新到 1.6.0。
